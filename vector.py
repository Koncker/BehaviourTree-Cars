...
from vector_util import format_number
...
class Vector(object):
    ...
    def from_iter(cls, iterable):
        """Creates a Vector object from an iterable.
    ...
    def from_points(cls, p1, p2):
        """Creates a Vector object between two points.
    ...
    def get_distance_to(self, p):
        ...
        @param: A Vector or list-like object with at least 2 values.
        @return: distance
        """
        x, y = self._v
        xx, yy = p
...
if __name__ == "__main__":
    ...
    v1 = Vector(1, 2)
    print v1('yx')
    print Vector.from_points((5,5), (10,10))
